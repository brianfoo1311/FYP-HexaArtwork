                ...
                <div class="col-md-7">
                    <div class="center_o1r text-end">
                        <h6 class="mb-0"><a href="#">Home</a> <span class="me-2 ms-2"><i
                                    class="fa fa-caret-right"></i></span> About Us</h6>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    <div class="about_pg1i row">
                        <div class="col-md-3 p-0">
                            ...
                            <span class="bg_pink text-white rounded-circle text-center d-inline-block fs-1"><i
                        ...
                        <div class="col-md-9">
                            <div class="about_pg1ir">
                                <h4>OUR ART</h4>
                                <p class="mb-0"> Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum
                                    lacinia
            ...
            <div class="row about_pg2 mt-5">
                <div class="col-md-4">
                    <div class="about_pg2i p-3">
                        ...
                        <p class="font_14 col_light mt-3 mb-0">Lorem ipsum dolor sit amet elit elit elit elit,
                            consectetur
                            adipiscing elit, sed do tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="about_pg2i p-3">
                ...
                <div class="col-md-4">
                    <div class="about_pg2i p-3">
                        ...
                        <h6 class="font_14 mb-3 col_light"><i class="fa fa-map-marker text-white me-2"></i> 119,
                            JimAvenue,
                            Daltinore, UK</h6>
                        <h6 class="font_14 mb-3 col_light"><i class="fa fa-phone text-white me-2"></i> +123 123 456</h6>
                        <h6 class="font_14 mb-4"><i class="fa fa-envelope text-white me-2"></i> <a class="col_light"
                                                                                                   href="#">info@gmail.com</a>
                        </h6>
                ...
                <div class="col-md-6">
                    <div class="about_h1r">
                        ...
                        <p>Sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                            magna
                            aliqua. Ut enim ad minim veniam, Lorem ipsum dolor quis nostrud exercitation ullamco</p>
